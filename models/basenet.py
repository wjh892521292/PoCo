...
class BaseNet(nn.Module):
    ...
    def save_model_best(self, step, best='best_recall', index=None,gpuid=1):
        ...
        if gpuid==1:
            ...
            save_dict = {
                'net_state_dict': self.module.state_dict(),
                'exp_name': self.args.exp_name,
                'iter': step,
                'index': index
            }
    ...
    def load_model_best(self, model_path):
        if os.path.exists(model_path):
            ...
            try:
                ...
                self.module.load_state_dict(net_state_dict)
    ...
    def load_model(self, model_path):
        ...
        self.load_state_dict(net_state_dict, strict=False)
        self.iter = load_dict['iter'] +1
